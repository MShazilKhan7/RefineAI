    ...
    <div className="min-h-[100dvh] flex bg-background text-foreground">
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center gap-3 px-4 py-3 mt-auto text-sm font-medium text-muted-foreground transition-colors hover:bg-destructive/10 hover:text-destructive border-t border-border/40"
        >
